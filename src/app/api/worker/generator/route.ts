...
3. 가독성을 위해 적절한 이모지와 <b>, <strong> 강조를 사용하며, 중요한 텍스트는 <span style="color: #2563eb">파란색</span> 또는 <span style="background-color: #fef08a">형광펜</span> 등 인라인 스타일(style 속성)을 적극 활용하여 시각적으로 다채롭고 색감 있게 표현해.
4. [매우 중요] 마크다운(Markdown, 예: ## 제목, **강조**)은 절대 사용하지 말고, 반드시 <h2>, <p>, <strong>, <span> 등 순수 HTML 태그만 사용하여 완벽한 HTML 구조로 출력할 것.`;
