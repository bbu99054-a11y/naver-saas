...
`
  ...
  if (tone.includes('성공 사례') || tone.includes('스토리텔링')) {
    return `
<tone_and_manner_guideline>
[선택된 톤앤매너: 🏆 성공 사례 스토리텔링 톤 (실제 사건 해결 중심)]
- 어조 및 문체: [의뢰인의 절망적인 초기 상황 ➔ 전문가의 숨은 쟁점 발굴 ➔ 극적인 권리 구제/해결]로 이어지는 흥미진진한 1인칭 해결 서사를 구사하세요 ("처음 사무실을 찾아오셨을 때만 해도...", "저희는 상대측이 간과한 맹점을 포착하여...").
- 서론 접근: 실제 상담이나 사건 의뢰 당시의 구체적인 위기 상황 에피소드로 생생하게 몰입감을 조성하세요.
- 본문 전개: 난관을 극복한 구체적인 전략과 실제 해결 과정의 실무 노하우를 단계적으로 생동감 있게 전개하세요.
- 결론 및 CTA: 유사한 위기에 처한 의뢰인에게 실질적인 성공 솔루션을 제시하며 신뢰감을 극대화하세요.
</tone_and_manner_guideline>
`
  }
